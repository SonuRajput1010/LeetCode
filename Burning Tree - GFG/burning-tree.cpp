...
class Solution {
  public:
    Node* mappingToParents(Node* root, int target, map<Node*,Node*>&nodeToParent){
    ...
    int minTime(Node* root, int target) 
    {
        ...
        Node* targteNode = mappingToParents(root,target,nodeToParent);
        return burningTree(targteNode,nodeToParent);
